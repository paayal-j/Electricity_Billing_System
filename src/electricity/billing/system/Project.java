...
public class Project extends JFrame implements ActionListener {
    ...
    Project(String atype, String meter) {
        ...
        master.setFont(new Font("Roboto", Font.BOLD, 20));
        ...
        depositdetails.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        calculatebill.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        info.setFont(new Font("Roboto", Font.BOLD, 20));

        JMenuItem updateinformation = new JMenuItem("Update Information");
        updateinformation.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        viewinformation.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        paybill.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        billdetails.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        report.setFont(new Font("Roboto", Font.BOLD, 20));
        ...
        utility.setFont(new Font("Roboto", Font.BOLD, 20));

        JMenuItem notepad = new JMenuItem("Notepad");
        notepad.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        calculator.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        mexit.setFont(new Font("Roboto", Font.BOLD, 20));
